...
PROTOBUF_NAMESPACE_OPEN
template<> ::kjy::AddRequest* Arena::CreateMaybeMessage<::kjy::AddRequest>(Arena*);
template<> ::kjy::AddResponse* Arena::CreateMaybeMessage<::kjy::AddResponse>(Arena*);
template<> ::kjy::TranslateRequest* Arena::CreateMaybeMessage<::kjy::TranslateRequest>(Arena*);
template<> ::kjy::TranslateResponse* Arena::CreateMaybeMessage<::kjy::TranslateResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace kjy {
...
class TranslateRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:kjy.TranslateRequest) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:kjy.TranslateRequest)
 private:
  class _Internal;
...
class TranslateResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:kjy.TranslateResponse) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:kjy.TranslateResponse)
 private:
  class _Internal;
...
class AddRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:kjy.AddRequest) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:kjy.AddRequest)
 private:
  class _Internal;
...
class AddResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:kjy.AddResponse) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:kjy.AddResponse)
 private:
  class _Internal;
...
inline const std::string& TranslateRequest::msg() const {
  // @@protoc_insertion_point(field_get:kjy.TranslateRequest.msg)
...
void TranslateRequest::set_msg(ArgT0&& arg0, ArgT... args) {
 ...
 msg_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:kjy.TranslateRequest.msg)
}
inline std::string* TranslateRequest::mutable_msg() {
  std::string* _s = _internal_mutable_msg();
  // @@protoc_insertion_point(field_mutable:kjy.TranslateRequest.msg)
  return _s;
}
...
inline std::string* TranslateRequest::release_msg() {
  // @@protoc_insertion_point(field_release:kjy.TranslateRequest.msg)
  return msg_.Release();
}
inline void TranslateRequest::set_allocated_msg(std::string* msg) {
  ...
  // @@protoc_insertion_point(field_set_allocated:kjy.TranslateRequest.msg)
}
...
inline const std::string& TranslateResponse::msg() const {
  // @@protoc_insertion_point(field_get:kjy.TranslateResponse.msg)
  return _internal_msg();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void TranslateResponse::set_msg(ArgT0&& arg0, ArgT... args) {
 ...
 msg_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:kjy.TranslateResponse.msg)
}
inline std::string* TranslateResponse::mutable_msg() {
  std::string* _s = _internal_mutable_msg();
  // @@protoc_insertion_point(field_mutable:kjy.TranslateResponse.msg)
  return _s;
}
...
inline std::string* TranslateResponse::release_msg() {
  // @@protoc_insertion_point(field_release:kjy.TranslateResponse.msg)
  return msg_.Release();
}
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:kjy.TranslateResponse.msg)
}
...
inline int32_t AddRequest::num1() const {
  // @@protoc_insertion_point(field_get:kjy.AddRequest.num1)
...
inline void AddRequest::set_num1(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:kjy.AddRequest.num1)
}
...
inline int32_t AddRequest::num2() const {
  // @@protoc_insertion_point(field_get:kjy.AddRequest.num2)
...
inline void AddRequest::set_num2(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:kjy.AddRequest.num2)
}
...
inline int32_t AddResponse::result() const {
  // @@protoc_insertion_point(field_get:kjy.AddResponse.result)
...
inline void AddResponse::set_result(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:kjy.AddResponse.result)
}
